...
const PrivacyPolicy = () => (
  <Layout>
    <Container>
      ...
      <p>
        converge-app.net operates the app.converge-app.net website, which
      ...
      <p>
        ...
        decided to use our Service, the converge-app.net website.
      </p>
      ...
      <p>
        ...
        Terms and Conditions, which is accessible at app.converge-app.net,
