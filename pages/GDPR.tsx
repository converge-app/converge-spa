...
const GDPR = () => (
  <Layout>
    <Container maxWidth='md'>
      <h1>Privacy Policy for converge-app.net</h1>

      <p>
        At converge-app.net, accessible from app.converge-app.net, one of our
        main priorities is the privacy of our visitors. This Privacy Policy
        document contains types of information that is collected and recorded by
        converge-app.net and how we use it.
      </p>

      <p>
        If you have additional questions or require more information about our
        Privacy Policy, do not hesitate to contact us through email at
        converge.kjuulh@gmail.com
      </p>
      ...
      <p>
        converge-app.net legal basis for collecting and using the personal
      ...
      <ul>
        <li>converge-app.net needs to perform a contract with you</li>
        <li>You have given converge-app.net permission to do so</li>
        <li>
          Processing your personal information is in converge-app.net legitimate
          interests
        </li>
        <li>converge-app.net needs to comply with the law</li>
      </ul>

      <p>
        converge-app.net will retain your personal information only for as long
      ...
      <p>
        converge-app.net follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, converge-app.net uses 'cookies'. These cookies
      ...
      <p>
        ...
        advertising partners of converge-app.net.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on converge-app.net, which are sent
      ...
      <p>
        Note that converge-app.net has no access to or control over these
      ...
      <p>
        converge-app.net's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        converge-app.net does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        shared and/or collect in converge-app.net. This policy is not applicable
