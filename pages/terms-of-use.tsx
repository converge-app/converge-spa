...
const TermsOfUsePage = () => (
  <Layout>
    <Container maxWidth='md'>
      ...
      <p>
        The converge-app.net website located at app.converge-app.net is a
        copyrighted work belonging to converge-app.net. Certain features of the
      ...
      <p>
        ...
        converge-app.net uses ‘cookies’. These cookies are used to store
      ...
      <p>
        ...
        the Company should be sent to: Grenaavej 762 St.. After the Notice is
      ...
      <p>
        ...
        <a href='https://privacypolicytemplate.net/'>our Privacy Policy</a>.
      </p>
      ...
      <p>Address: Grenaavej 762 St.</p>
      <p>Email: converge.kjuulh@gmail.com</p>
    </Container>
  </Layout>
);
